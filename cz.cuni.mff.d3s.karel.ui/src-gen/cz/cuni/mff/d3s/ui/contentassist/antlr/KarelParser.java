...
* generated by Xtext
*/
package cz.cuni.mff.d3s.ui.contentassist.antlr;
...
public class KarelParser extends AbstractContentAssistParser {
	...
	@Override
	protected cz.cuni.mff.d3s.ui.contentassist.antlr.internal.InternalKarelParser createParser() {
		cz.cuni.mff.d3s.ui.contentassist.antlr.internal.InternalKarelParser result = new cz.cuni.mff.d3s.ui.contentassist.antlr.internal.InternalKarelParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMainAccess().getStatementsAssignment_1(), "rule__Main__StatementsAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			cz.cuni.mff.d3s.ui.contentassist.antlr.internal.InternalKarelParser typedParser = (cz.cuni.mff.d3s.ui.contentassist.antlr.internal.InternalKarelParser) parser;
