...
* generated by Xtext
*/
package cz.cuni.mff.d3s.parseTreeConstruction;
 ...
 *
 * Main:
 * 	"BEGIN-MAIN" statements+=Statement* "END-MAIN";
 *
 **/
...
protected class Main_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Main_ENDMAINKeyword_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "BEGIN-MAIN"
protected class Main_BEGINMAINKeyword_0 extends KeywordToken  {
	
	public Main_BEGINMAINKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMainAccess().getBEGINMAINKeyword_0();
	}
...
// statements+=Statement*
protected class Main_StatementsAssignment_1 extends AssignmentToken  {
	
	public Main_StatementsAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMainAccess().getStatementsAssignment_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getStatementRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMainAccess().getStatementsStatementParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Main_StatementsAssignment_1(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new Main_BEGINMAINKeyword_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "END-MAIN"
protected class Main_ENDMAINKeyword_2 extends KeywordToken  {
	
	public Main_ENDMAINKeyword_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMainAccess().getENDMAINKeyword_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Main_StatementsAssignment_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Main_BEGINMAINKeyword_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
