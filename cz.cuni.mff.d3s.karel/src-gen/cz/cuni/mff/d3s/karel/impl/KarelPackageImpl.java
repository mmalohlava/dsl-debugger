...
import cz.cuni.mff.d3s.karel.CommandKind;
import cz.cuni.mff.d3s.karel.CommandStatement;
import cz.cuni.mff.d3s.karel.ConditionExpr;
import cz.cuni.mff.d3s.karel.ConditionKind;
import cz.cuni.mff.d3s.karel.DocumentationComment;
import cz.cuni.mff.d3s.karel.HeadingKind;
import cz.cuni.mff.d3s.karel.IfStatement;
import cz.cuni.mff.d3s.karel.InitBoardSizeCommand;
import cz.cuni.mff.d3s.karel.InitCommand;
import cz.cuni.mff.d3s.karel.InitHeadingCommand;
import cz.cuni.mff.d3s.karel.InitPositionCommand;
import cz.cuni.mff.d3s.karel.InitSection;
import cz.cuni.mff.d3s.karel.IterateStatement;
import cz.cuni.mff.d3s.karel.KarelFactory;
import cz.cuni.mff.d3s.karel.KarelPackage;
import cz.cuni.mff.d3s.karel.Main;
import cz.cuni.mff.d3s.karel.Program;
import cz.cuni.mff.d3s.karel.Statement;
import cz.cuni.mff.d3s.karel.UserDefinedCommand;
import cz.cuni.mff.d3s.karel.UserDefinedCommandStatement;
import cz.cuni.mff.d3s.karel.WhileStatement;
...
public class KarelPackageImpl extends EPackageImpl implements KarelPackage
{
   ...
   * @see cz.cuni.mff.d3s.karel.KarelPackage#eNS_URI
   * @see #init()
   * @generated
   */
