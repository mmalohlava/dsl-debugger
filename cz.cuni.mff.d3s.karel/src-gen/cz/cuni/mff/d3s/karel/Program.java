 ...
 * <ul>
 *   <li>{@link cz.cuni.mff.d3s.karel.Program#getInitSection <em>Init Section</em>}</li>
 *   <li>{@link cz.cuni.mff.d3s.karel.Program#getUserDefinedCommands <em>User Defined Commands</em>}</li>
 *   <li>{@link cz.cuni.mff.d3s.karel.Program#getMain <em>Main</em>}</li>
 * </ul>
 * </p>
 *
 * @see cz.cuni.mff.d3s.karel.KarelPackage#getProgram()
 * @model
 * @generated
 */
public interface Program extends EObject
{
   ...
   * @see cz.cuni.mff.d3s.karel.KarelPackage#getProgram_InitSection()
  ...
  /**
   * Sets the value of the '{@link cz.cuni.mff.d3s.karel.Program#getInitSection <em>Init Section</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link cz.cuni.mff.d3s.karel.UserDefinedCommand}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see cz.cuni.mff.d3s.karel.KarelPackage#getProgram_UserDefinedCommands()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setMain(Main)
   * @see cz.cuni.mff.d3s.karel.KarelPackage#getProgram_Main()
   * @model containment="true"
   * @generated
   */
  Main getMain();
  ...
  /**
   * Sets the value of the '{@link cz.cuni.mff.d3s.karel.Program#getMain <em>Main</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
